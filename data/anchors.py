...
def mk_anchors(size, multiscale_size, size_pattern, step_pattern, num_reglayer = 6, param = 2):
    ...
    print('Feature Map Scales: {}'.format(cfg['feature_maps']))
    print('Min Anchor Box: {}'.format(cfg['min_sizes']))
    print('Max Anchor Box: {}'.format(cfg['max_sizes']))
    print('Aspect ratios of Anchor Boxes: {}'.format(cfg['aspect_ratios']))
